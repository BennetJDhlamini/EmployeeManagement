        ...
        public async Task<IActionResult> DeleteUser(string id)
        {
            ...
            else
            {
                ...
                catch (DbUpdateException ex)
                {
                    ...
                    ViewBag.ErrorTitle = $"{user} is in use";
                    ViewBag.ErrorMessage = $"{user} cannot be deleted as there are roles in this user. If you want to delete this user, please remove the role from the user and then try to delete";
                    return View("Error");
                }
